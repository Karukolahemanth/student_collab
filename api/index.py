"""
Vercel serverless entry point — self-contained Flask app.
All code lives here so Vercel bundles everything correctly.
"""
...
if DATABASE_URL:
    ...
    print("[Warning] DATABASE_URL not set — DB features unavailable.")
